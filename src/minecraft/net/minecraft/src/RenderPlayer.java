...
public class RenderPlayer extends RenderLiving
{
    ...
    private static final String[] armorFilenamePrefix = new String[] {"cloth", "chain", "iron", "diamond", "gold", "rubis", "em", "ob"};
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
        ...
        if (this.loadDownloadableImageTexture(par1EntityPlayer.cloakUrl, (String)null) && !par1EntityPlayer.getHasActivePotion() && !par1EntityPlayer.getHideCape())
        {
            ...
            double var25 = par1EntityPlayer.field_71091_bM + (par1EntityPlayer.field_71094_bP - par1EntityPlayer.field_71091_bM) * (double)par2 - (par1EntityPlayer.prevPosX + (par1EntityPlayer.posX - par1EntityPlayer.prevPosX) * (double)par2);
            ...
            float var19 = (float)(var25 * var14 + var12 * var16) * 100.0F;
            float var20 = (float)(var25 * var16 - var12 * var14) * 100.0F;
        ...
        ItemStack var24 = par1EntityPlayer.inventory.getCurrentItem();
        ...
        if (var24 != null)
        {
            ...
            {
                var24 = new ItemStack(Item.stick);
            }
            ...
            {
                var9 = var24.getItemUseAction();
            }

            if (var24.itemID < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[var24.itemID].getRenderType()))
            {
                var5 = 0.5F;
            ...
            else if (var24.itemID == Item.bow.itemID)
            {
                var5 = 0.625F;
            ...
            else if (var24.itemID == Item.arba.itemID)
            {
                var5 = 0.625F;
                GL11.glTranslatef(0.0F, 0.125F, 0.3125F);
            ...
            else if (var24.itemID == Item.arcrecul.itemID)
            {
                var5 = 0.625F;
                GL11.glTranslatef(0.0F, 0.125F, 0.3125F);
                GL11.glRotatef(-20.0F, 0.0F, 1.0F, 0.0F);
            ...
            else if (Item.itemsList[var24.itemID].isFull3D())
            {
                var5 = 0.625F;

                if (Item.itemsList[var24.itemID].shouldRotateAroundWhenRendering())
                {
            ...
            if (var24.getItem().requiresMultipleRenderPasses())
            {
                ...
                {
                    int var13 = var24.getItem().getColorFromItemStack(var24, var11);
                    ...
                    this.renderManager.itemRenderer.renderItem(par1EntityPlayer, var24, var11);
                }
            }
            else
            {
                var11 = var24.getItem().getColorFromItemStack(var24, 0);
                ...
                this.renderManager.itemRenderer.renderItem(par1EntityPlayer, var24, 0);
            }
