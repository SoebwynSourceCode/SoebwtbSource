...
public class GuiTexturePacks extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        String var5 = FontColors.DARK_RED + "X-Ray/Cheat INTERDIT";
        this.drawString(this.fontRenderer, var5, this.width - this.fontRenderer.getStringWidth(var5) - 15, this.height - 230, 16776960);
