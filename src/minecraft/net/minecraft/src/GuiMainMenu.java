...
public class GuiMainMenu extends GuiScreen
{
    ...
    private void addSingleplayerMultiplayerButtons(int par1, int par2, StringTranslate par3StringTranslate)
    {
        ...
        this.buttonList.add(new GuiButtonTp(1, this.width / 2 - 100, par1 + 15 + 10, 200, 20, "Serveur Soebwyn : Pvp/Factions"));
        this.buttonList.add(new GuiButton(2, this.width / 2 + 2, par1 + 1 + 1, 99, 20, par3StringTranslate.translateKey(FontColors.BLUE + "TeamSpeak")));
        this.buttonList.add(new GuiButtonTs(29, this.width / 2 + 150, par1 + 1 + 1));
        this.buttonList.add(new GuiButton(28, this.width / 2 - 100, par1 + 1 + 1, 98, 20, par3StringTranslate.translateKey(FontColors.BLUE + "Soebwyn.fr")));
        this.buttonList.add(new GuiButton(3, this.width / 2 + 150, par1 + 15 + 10, 60, 20, par3StringTranslate.translateKey(FontColors.GOLD + "Boutique")));
        this.buttonList.add(new GuiButton(31, this.width / 2 - 100, var5 + 48, var4.translateKey(FontColors.AQUA + "Textures Packs")));
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        if (par1GuiButton.id == 29)
        {
            ...
            try
            {
                var3 = new URI("https://twitter.com/SoebwynServeur");
            ...
            {
                Logger.getLogger(Menu.class.getName()).log(Level.SEVERE, (String)null, var8);
            }
        }

        if (par1GuiButton.id == 31)
        {
            this.mc.displayGuiScreen(new GuiTexturePacks(this, this.mc.gameSettings));
        }

        if (par1GuiButton.id == 1)
        {
            this.mc.displayGuiScreen(new GuiConnecting(this, this.mc, "91.121.61.84", 25128));
        }
        ...
        if (par1GuiButton.id == 2)
        {
            ...
            try
            {
                var3 = new URI("ts3server://ts.soebwyn.fr:9993");
            ...
            {
                Logger.getLogger(Menu.class.getName()).log(Level.SEVERE, (String)null, var7);
            }
        }

        if (par1GuiButton.id == 28)
        {
            var2 = null;

            try
            {
                var3 = new URI("http://www.soebwyn.fr");
            ...
            {
                Logger.getLogger(Menu.class.getName()).log(Level.SEVERE, (String)null, var6);
            }
        }
        ...
        if (par1GuiButton.id == 3)
        {
            ...
            try
            {
                var3 = new URI("http://www.soebwyn.fr/boutique/");
        ...
        if (par1GuiButton.id == 12)
        {
            ...
            WorldInfo var9 = var10.getWorldInfo("Demo_World");

            if (var9 != null)
            {
                GuiYesNo var4 = GuiSelectWorld.getDeleteWorldScreen(this, var9.getWorldName(), 12);
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glPopMatrix();
        String var9 = "1.3.5 Soebwyn bas\u00e9e sur Minecraft 1.5.1";
        ...
        String var11 = FontColors.GRAY + "Copyright Soebwyn";
        this.drawString(this.fontRenderer, var11, this.width - this.fontRenderer.getStringWidth(var11) - 15, this.height - 245, 16776960);
