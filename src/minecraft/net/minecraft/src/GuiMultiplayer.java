...
public class GuiMultiplayer extends GuiScreen
{
    ...
    public void initGuiControls()
    {
        ...
        this.buttonList.add(new GuiButton(4, this.width / 2 - 50, this.height - 52, 200, 20, var1.translateKey("Retour !!")));
    ...
    private static void func_74017_b(ServerData par1ServerData) throws IOException
    {
        ...
        try
        {
            ...
            {
                var9 = var5.substring(1).split("\u0000");

                if (MathHelper.parseIntWithDefault(var9[0], 0) == 1)
                {
                    par1ServerData.serverMOTD = var9[3];
                    par1ServerData.field_82821_f = MathHelper.parseIntWithDefault(var9[1], par1ServerData.field_82821_f);
                    par1ServerData.gameVersion = var9[2];
                    var7 = MathHelper.parseIntWithDefault(var9[4], 0);
                    var8 = MathHelper.parseIntWithDefault(var9[5], 0);

                    if (var7 >= 0 && var8 >= 0)
                    {
                        par1ServerData.populationInfo = EnumChatFormatting.GRAY + "" + var7 + "" + EnumChatFormatting.DARK_GRAY + "/" + EnumChatFormatting.GRAY + var8;
                    }
                    else
                    {
                        par1ServerData.populationInfo = "" + EnumChatFormatting.DARK_GRAY + "INTERDIT";
                    }
                }
                else
                {
                    par1ServerData.gameVersion = "???";
                    par1ServerData.serverMOTD = "" + EnumChatFormatting.DARK_GRAY + "INTERDIT";
