...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    public float getFOVMultiplier()
    {
        ...
        {
            var2 = this.getItemInUseDuration();
        ...
        if (this.isUsingItem() && this.getItemInUse().itemID == Item.arba.itemID)
        {
            var2 = this.getItemInUseDuration();
            var3 = (float)var2 / 20.0F;
        ...
        if (this.isUsingItem() && this.getItemInUse().itemID == Item.arcrecul.itemID)
        {
            var2 = this.getItemInUseDuration();
            var3 = (float)var2 / 20.0F;
    ...
    {
        this.cloakUrl = "http://soebwyn.fr/capes/" + StringUtils.stripControlCodes(this.username) + ".png";
    }
