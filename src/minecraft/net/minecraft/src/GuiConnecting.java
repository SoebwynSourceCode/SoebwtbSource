...
public class GuiConnecting extends GuiScreen
{
    ...
    {
        this.mc.getLogAgent().logInfo("Chargement/Conexion a Soebwyn ...");
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        if (this.clientHandler == null)
        {
            this.drawCenteredString(this.fontRenderer, var4.translateKey("Chargement de Soebwyn"), this.width / 2, this.height / 2 - 50, 16777215);
            this.drawCenteredString(this.fontRenderer, "", this.width / 2, this.height / 2 - 10, 16777215);
        }
        else
        {
            this.drawCenteredString(this.fontRenderer, var4.translateKey("Validation de votre Compte sur Soebwyn"), this.width / 2, this.height / 2 - 50, 16777215);
