...
import net.minecraft.src.GuiCTP;
...
import net.minecraft.src.GuiTp;
...
public abstract class Minecraft implements Runnable, IPlayerUsage
{
    ...
    public void startGame() throws LWJGLException
    {
        ...
        Display.setTitle("Minecraft Minecraft 1.5.1 - Version Soebwyn");
        this.getLogAgent().logInfo("Soebwyn Version by Engue0774");
    ...
    private void checkGLError(String par1Str)
    {
        ...
        if (var2 != 0)
        {
            ...
            this.getLogAgent().func_98232_c("########## GL ERROR (OpenGl Erreur) ##########");
    ...
    public void runTick()
    {
        ...
        if (this.currentScreen != null)
        {
            ...
            {
                var1 = CrashReport.makeCrashReport(var10, "Updating screen events");
            ...
            if (this.currentScreen != null)
            {
                ...
                {
                    var1 = CrashReport.makeCrashReport(var9, "Ticking screen particles");
                    var2 = var1.makeCategory("Affected screen");
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                var12 = Keyboard.isKeyDown(42) | Keyboard.isKeyDown(54);
                                this.gameSettings.setOptionValue(EnumOptions.RENDER_DISTANCE, var12 ? -1 : 1);
                            }
            ...
            var12 = this.gameSettings.chatVisibility != 2;
            ...
            while (this.gameSettings.KeyBindTp.isPressed())
            {
                this.displayGuiScreen(new GuiTp(this, this.theWorld));

                try
                {
                    this.getMoney = new URL("http://www.soebwyn.fr/launcher/getMoney.php?username=" + this.thePlayer.getEntityName());
                }
                ...
                try
                {
                    BufferedReader var13 = new BufferedReader(new InputStreamReader(this.getMoney.openStream()));
            ...
            while (this.gameSettings.KeyBindCtp.isPressed())
            {
                this.displayGuiScreen(new GuiCTP(this, this.theWorld));
            }
        ...
        if (this.theWorld != null)
        {
            ...
            if (!this.isGamePaused)
            {
                ...
                {
                    var1 = CrashReport.makeCrashReport(var11, "Exception in world tick");
    ...
    public static void main(String[] par0ArrayOfStr)
    {
        ...
        var16.setTitle("Minecraft AND Modding Soebwyn");
    ...
    private void clickMiddleMouseButton()
    {
        if (this.objectMouseOver != null)
        {
            ...
            if (this.objectMouseOver.typeOfHit == EnumMovingObjectType.TILE)
            {
                ...
                int var9 = var4 < 256 && !Block.blocksList[var8.blockID].func_82505_u_() ? var4 : var8.blockID;
            ...
            else
            {
                ...
                else if (this.objectMouseOver.entityHit instanceof EntityMinecart)
                {
                    ...
                    if (var10.func_94087_l() == 2)
                    {
                        var4 = Item.minecartPowered.itemID;
                    }
                    else if (var10.func_94087_l() == 1)
                    {
                        var4 = Item.minecartCrate.itemID;
                    }
                    else if (var10.func_94087_l() == 3)
                    {
                        var4 = Item.tntMinecart.itemID;
                    }
                    else if (var10.func_94087_l() == 5)
                    {
                        var4 = Item.hopperMinecart.itemID;
                    }
                    else
                    {
