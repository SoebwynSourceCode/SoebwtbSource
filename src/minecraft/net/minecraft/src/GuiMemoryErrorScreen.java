...
public class GuiMemoryErrorScreen extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.drawCenteredString(this.fontRenderer, "Out of memory! (Plus de m\u00e9moire)", this.width / 2, this.height / 4 - 60 + 20, 16777215);
        ...
        this.drawString(this.fontRenderer, "Please restart the game if you see this message again.(Sinon Soebwyn.fr, pour le support)", this.width / 2 - 140, this.height / 4 - 60 + 60 + 99, 10526880);
