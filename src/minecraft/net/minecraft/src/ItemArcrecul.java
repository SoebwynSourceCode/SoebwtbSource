...
public class ItemArcrecul extends Item
{
    public static final String[] ArcreculPullIconNameArray = new String[] {"arcrecul_pull_0", "arcrecul_pull_1", "arcrecul_pull_2"};
    private Icon[] iconArray;

    public ItemArcrecul(int var1)
    {
        super(var1);
        this.maxStackSize = 1;
    ...
    public void onPlayerStoppedUsing(ItemStack var1, World var2, EntityPlayer var3, int var4)
    {
        ...
        if (var5 || var3.inventory.hasItem(Item.arrow.itemID))
        {
            ...
            int var10 = EnchantmentHelper.getEnchantmentLevel(Enchantment.punch.effectId, var1) + 2;
    ...
    public void updateIcons(IconRegister var1)
    {
        ...
        this.iconArray = new Icon[ArcreculPullIconNameArray.length];

        for (int var2 = 0; var2 < this.iconArray.length; ++var2)
        {
            this.iconArray[var2] = var1.registerIcon(ArcreculPullIconNameArray[var2]);
        }
    }
