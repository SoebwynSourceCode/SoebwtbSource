...
public enum EnumArmorMaterial
{
    ...
    RUBIS(35, new int[]{3, 8, 6, 3}, 15),
    EM(39, new int[]{4, 6, 7, 4}, 8),
    OB(20, new int[]{5, 7, 7, 2}, 9);
    ...
    {
        return this == CLOTH ? Item.leather.itemID : (this == CHAIN ? Item.ingotIron.itemID : (this == GOLD ? Item.ingotGold.itemID : (this == IRON ? Item.ingotIron.itemID : (this == DIAMOND ? Item.diamond.itemID : (this == RUBIS ? Item.ingotRubis.itemID : (this == EM ? Item.emerald.itemID : (this == OB ? Block.obsidian.blockID : 0)))))));
    }
}
