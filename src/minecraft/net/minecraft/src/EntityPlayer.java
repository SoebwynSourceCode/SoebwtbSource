...
public abstract class EntityPlayer extends EntityLiving implements ICommandSender
{
    ...
    public Icon getItemIcon(ItemStack par1ItemStack, int par2)
    {
        ...
        else
        {
            ...
            {
                var4 = par1ItemStack.getMaxItemUseDuration() - this.itemInUseCount;
            ...
            if (this.itemInUse != null && par1ItemStack.itemID == Item.arba.itemID)
            {
                var4 = par1ItemStack.getMaxItemUseDuration() - this.itemInUseCount;

                if (var4 >= 18)
                {
                    return Item.arba.func_94599_c(2);
                }

                if (var4 > 13)
                {
                    return Item.arba.func_94599_c(1);
                }

                if (var4 > 0)
                {
                    return Item.arba.func_94599_c(0);
                }
            }

            if (this.itemInUse != null && par1ItemStack.itemID == Item.arcrecul.itemID)
            {
                var4 = par1ItemStack.getMaxItemUseDuration() - this.itemInUseCount;

                if (var4 >= 18)
                {
                    return Item.arcrecul.func_94599_c(2);
                }

                if (var4 > 13)
                {
                    return Item.arcrecul.func_94599_c(1);
                }

                if (var4 > 0)
                {
                    return Item.arcrecul.func_94599_c(0);
                }
            }
        }
