...
public enum EnumEnchantmentType
{
    ...
    public boolean canEnchantItem(Item par1Item)
    {
        ...
        {
            return par1Item instanceof ItemSword ? this == weapon : (par1Item instanceof ItemTool ? this == digger : (par1Item instanceof ItemArba ? this == bow : (par1Item instanceof ItemArcrecul ? this == bow : (par1Item instanceof ItemBow ? this == bow : false))));
        }
    }
}
