...
public class Block
{
    ...
    public static final Block engue = (new Block(159, Material.rock)).setHardness(2.0F).setResistance(50.0F).setStepSound(soundStoneFootstep).getIndirectPowerOutput("engue").setCreativeTab(CreativeTabs.tabDecorations);
    public static final Block blockCharb = (new BlockOreStorage(160)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).getIndirectPowerOutput("blockcharb");
