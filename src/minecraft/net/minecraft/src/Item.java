...
public class Item
{
    ...
    public static Item ghastTear = (new Item(114)).setUnlocalizedName("ghastTear").setPotionEffect("+0-1-2-3&4-4+13").setCreativeTab(CreativeTabs.tabBrewing);
    ...
    public static Item batonadmin = (new Item(153)).setUnlocalizedName("batonadmin").setCreativeTab(CreativeTabs.tabCombat);
    public static Item vin = (new ItemVin(154, 8, 0.3F, false)).setUnlocalizedName("vin");
    public static Item ingotRubis = (new Item(155)).setUnlocalizedName("ingotRubis").setCreativeTab(CreativeTabs.tabMaterials);
    public static Item swordRubis = (new ItemSword(156, EnumToolMaterial.RUBIS)).setUnlocalizedName("swordRubis");
    public static Item axeRubis = (new ItemAxe(157, EnumToolMaterial.RUBIS)).setUnlocalizedName("axeRubis");
    public static Item pickaxeRubis = (new ItemPickaxe(158, EnumToolMaterial.RUBIS)).setUnlocalizedName("pickaxeRubis");
    public static Item shovelRubis = (new ItemSpade(159, EnumToolMaterial.RUBIS)).setUnlocalizedName("shovelRubis");
    public static Item hoeRubis = (new ItemHoe(160, EnumToolMaterial.RUBIS)).setUnlocalizedName("hoeRubis");
    public static ItemArmor helmetRubis = (ItemArmor)(new ItemArmor(161, EnumArmorMaterial.RUBIS, 5, 0)).setUnlocalizedName("helmetRubis");
    public static ItemArmor plateRubis = (ItemArmor)(new ItemArmor(162, EnumArmorMaterial.RUBIS, 5, 1)).setUnlocalizedName("chestplateRubis");
    public static ItemArmor legsRubis = (ItemArmor)(new ItemArmor(163, EnumArmorMaterial.RUBIS, 5, 2)).setUnlocalizedName("leggingsRubis");
    public static ItemArmor bootsRubis = (ItemArmor)(new ItemArmor(164, EnumArmorMaterial.RUBIS, 5, 3)).setUnlocalizedName("bootsRubis");
    public static Item swordEM = (new ItemSword(165, EnumToolMaterial.EM)).setUnlocalizedName("swordEM");
    public static Item axeEM = (new ItemAxe(166, EnumToolMaterial.EM)).setUnlocalizedName("axeEM");
    public static Item pickaxeEM = (new ItemPickaxe(167, EnumToolMaterial.EM)).setUnlocalizedName("pickaxeEM");
    public static Item shovelEM = (new ItemSpade(168, EnumToolMaterial.EM)).setUnlocalizedName("shovelEM");
    public static Item hoeEM = (new ItemHoe(169, EnumToolMaterial.EM)).setUnlocalizedName("hoeEM");
    public static ItemArmor helmetEM = (ItemArmor)(new ItemArmor(170, EnumArmorMaterial.EM, 6, 0)).setUnlocalizedName("helmetEM");
    public static ItemArmor plateEM = (ItemArmor)(new ItemArmor(171, EnumArmorMaterial.EM, 6, 1)).setUnlocalizedName("chestplateEM");
    public static ItemArmor legsEM = (ItemArmor)(new ItemArmor(172, EnumArmorMaterial.EM, 6, 2)).setUnlocalizedName("leggingsEM");
    public static ItemArmor bootsEM = (ItemArmor)(new ItemArmor(173, EnumArmorMaterial.EM, 6, 3)).setUnlocalizedName("bootsEM");
    public static Item swordOB = (new ItemSword(174, EnumToolMaterial.OB)).setUnlocalizedName("swordOB");
    public static Item axeOB = (new ItemAxe(175, EnumToolMaterial.OB)).setUnlocalizedName("axeOB");
    public static Item pickaxeOB = (new ItemPickaxe(176, EnumToolMaterial.OB)).setUnlocalizedName("pickaxeOB");
    public static Item shovelOB = (new ItemSpade(177, EnumToolMaterial.OB)).setUnlocalizedName("shovelOB");
    public static Item hoeOB = (new ItemHoe(178, EnumToolMaterial.OB)).setUnlocalizedName("hoeOB");
    public static ItemArmor helmetOB = (ItemArmor)(new ItemArmor(179, EnumArmorMaterial.OB, 7, 0)).setUnlocalizedName("helmetOB");
    public static ItemArmor plateOB = (ItemArmor)(new ItemArmor(180, EnumArmorMaterial.OB, 7, 1)).setUnlocalizedName("chestplateOB");
    public static ItemArmor legsOB = (ItemArmor)(new ItemArmor(181, EnumArmorMaterial.OB, 7, 2)).setUnlocalizedName("leggingsOB");
    public static ItemArmor bootsOB = (ItemArmor)(new ItemArmor(182, EnumArmorMaterial.OB, 7, 3)).setUnlocalizedName("bootsOB");
    public static ItemArba arba = (ItemArba)(new ItemArba(183)).setUnlocalizedName("arba");
    public static ItemArcrecul arcrecul = (ItemArcrecul)(new ItemArcrecul(184)).setUnlocalizedName("arcrecul");
